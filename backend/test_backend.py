...
def test_vector_store_search():
    ...
    vector_store = VectorStore()
    test_chunks = [
        {"text": "Python is used for data science", "start": 0, "end": 31},
        {"text": "JavaScript is used for web development", "start": 0, "end": 39},
        {"text": "Java is used for enterprise applications", "start": 0, "end": 41}
    ]
